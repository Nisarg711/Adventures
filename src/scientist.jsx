...
const Scientist = () => {
  return (
    <div>
      ...
      <p id="APJ">If you want to shine like a SUN….First Burn like one -Dr.APJ Abdul Kalam</p>
      <h4>
        India has a rich history of influential scientists who have made significant contributions across various fields. Here are a few notable Indian scientists:
      </h4>
      ...
      <div className="Science">
        <div className="boxes">
          ...
          <p>
            <b>C.V. Raman: </b> An acclaimed physicist, C.V. Raman won the Nobel Prize in Physics in 1930 for his discovery of the Raman Effect, which explains how light interacts with molecules. This discovery laid the foundation for Raman spectroscopy, a crucial tool in molecular physics and chemistry.
          </p>
        </div>
        ...
        <div className="boxes">
          ...
          <p>
            <b>Subrahmanyan Chandrasekhar:</b> An astrophysicist who won the Nobel Prize in Physics in 1983 for his theoretical studies of the physical processes important to the structure and evolution of stars, particularly his work on the Chandrasekhar limit, which defines the maximum mass of a stable white dwarf star.
          </p>
        </div>
        ...
        <div className="boxes">
          ...
          <p>
            <b>Ramanathan Ramanan:</b> A mathematician known for his work in number theory and his contributions to the understanding of prime numbers.
