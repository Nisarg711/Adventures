...
const game2 = () => {
  ...
  return (
    ...
    <div className="memory-card" data-framework="halley'sComet">
      <img className="front-face1" src="/Constitutes/halley'scomet.jpg" alt="Halley's Comet" />
    ...
    <div className="memory-card" data-framework="se">
      <img className="front-face1" src="/Constitutes/solareclipse.jpg" alt="Solar Eclipse"/> 
      <img className="back-face" src="/Scientists/Back.jpg" alt="Back_of_card" />
    </div>
    <div className="memory-card" data-framework="se">
    ...
    <div className="memory-card" data-framework="chandra">
      <img className="front-face1" src="/Constitutes/chandrayan.jpg" alt="Chandrayaan 3" />
      <img className="back-face" src="/Scientists/Back.jpg" alt="Back_of_card" />
    </div>
    <div className="memory-card" data-framework="chandra">
    ...
    <div className="memory-card" data-framework="om">
      <img className="front-face1" src="/Constitutes/olympusmons.jpg" alt="Olympus Mons" />
      <img className="back-face" src="/Scientists/Back.jpg" alt="Back_of_card" />
    </div>
    <div className="memory-card" data-framework="om">
    ...
    <div className="memory-card" data-framework="galaxy">
      <img className="front-face1" src="/Constitutes/andromeda.jpg" alt="Andromeda" />
      <img className="back-face" src="/Scientists/Back.jpg" alt="Back_of_card" />
    </div>
    <div className="memory-card" data-framework="galaxy">
    ...
    <div className="memory-card" data-framework="Milky way">
      <img className="front-face1" src="/Constitutes/milkyway.jpg" alt="Milky way" />
      <img className="back-face" src="/Scientists/Back.jpg" alt="Back_of_card" />
    </div>
    <div className="memory-card" data-framework="Milky way">
